...
DEFAULT_EVENTS = [
    dict(
        ...
        city="Las Vegas, NV", country="USA", starting_price=None, tickets_available=0,
    ...
    dict(
        ...
        city="Miami, FL", country="USA", starting_price=185, tickets_available=46,
    ...
    dict(
        ...
        city="Indio, CA", country="USA", starting_price=549, tickets_available=120,
        status="on-sale", featured=True,
    ),
    dict(
        ...
        city="San Francisco, CA", country="USA", starting_price=340, tickets_available=18,
    ...
    dict(
        ...
        city="Los Angeles, CA", country="USA", starting_price=129, tickets_available=64,
    ...
    dict(
        ...
        city="New York, NY", country="USA", starting_price=95, tickets_available=87,
        status="on-sale", featured=False,
    ),
    dict(
        ...
        city="Arlington, TX", country="USA", starting_price=210, tickets_available=12,
        status="limited", featured=False,
    ),
    dict(
        ...
        city="Las Vegas, NV", country="USA", starting_price=79, tickets_available=143,
        status="on-sale", featured=False,
    ),
    dict(
        ...
        city="Queens, NY", country="USA", starting_price=265, tickets_available=39,
        status="on-sale", featured=False,
    ),
    dict(
        ...
        city="Park City, UT", country="USA", starting_price=None, tickets_available=0,
    ...
    dict(
        ...
        city="Los Angeles, CA", country="USA", starting_price=89, tickets_available=71,
        status="on-sale", featured=False,
    ),
    dict(
        ...
        city="Austin, TX", country="USA", starting_price=165, tickets_available=210,
        status="on-sale", featured=False,
    ),
]
