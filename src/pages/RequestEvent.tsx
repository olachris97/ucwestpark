    ...
    return (
      <div className="mx-auto flex min-h-[60vh] max-w-xl flex-col items-center justify-center px-5 py-20 text-center">
        ...
        <p className="mt-3 leading-relaxed text-ink-soft">
          We couldn't find a parking option for that event in our current listings, but our team will search
          for available parking on your behalf. We'll contact you using the information
          you provided.
        </p>
  ...
  return (
    <div className="bg-paper">
      ...
      >
        ...
        <FormSection title="Event & parking information">
          <Field
            label="Event name"
            value={eventName}
          ...
          <p className="mt-2 text-xs text-ink-soft">
            We currently help source parking for events across the United States.
          </p>
          <div className="mt-4">
            <Field label="Venue / location (if known)" value={venue} onChange={setVenue} />
          </div>
        </FormSection>
