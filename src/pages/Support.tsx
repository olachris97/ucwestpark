...
const faqs = [
  {
    q: "Am I buying parking directly through this site?",
    a: "You can browse parking options here, and when a spot requires a request, our team searches for availability that matches your event, location preference, and budget before anything is booked.",
  },
  {
    q: "Is there a fee to submit a request?",
    a: "Submitting a parking request is free. Any parking price you're quoted will be shared clearly before you commit to anything.",
  },
  {
    q: "What if my event isn't listed?",
    a: "Use the \"Request Parking\" form. Tell us the event, date, and city if you know them, and our team will look into availability on your behalf.",
  },
  {
        ...
        <div className="grid grid-cols-1 gap-8 lg:grid-cols-[0.8fr_1.2fr]">
          <div>
            ...
            <p className="mt-3 max-w-md text-sm leading-relaxed text-ink-soft">
              ...
              For parking requests, include your event and reference number if you have one.
            </p>
