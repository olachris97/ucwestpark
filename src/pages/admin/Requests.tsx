  ...
  return (
    <div>
      ...
      <p className="mt-1 text-sm text-ink-soft">
        Ticket requests, custom event requests, and contact messages submitted through the site.
      </p>
      ...
      <div className="mt-6 flex flex-wrap gap-3">
        ...
        >
          ...
          <option value="ticket">Ticket requests</option>
              ...
              <div key={r.id} className="px-5 py-4">
                ...
                {expanded === r.id && (
                  <div className="mt-4 grid grid-cols-1 gap-x-8 gap-y-2 rounded-lg bg-paper-stub/60 p-4 text-sm sm:grid-cols-2">
                    ...
                    {r.kind !== "contact" && (
                      <>
                        <Detail label="Tickets requested" value={String(r.ticketQuantity)} />
                        <Detail label="Budget" value={r.budget || "—"} />
                        <Detail label="Seating preference" value={String(r.seatPreference) || "—"} />
                      </>
                    )}
                    {r.kind === "custom-event" && (
                      <>
